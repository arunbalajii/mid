...
public class Report {
	...
	private static String filePath = "C:\\Users\\saahmed\\workspace\\MFM_Lite\\test-output\\MFM_Lite_Sanity_Report.html";
	public static WebDriver browser = BrowserFactory.getBrowser("Browser","URL");
	static String imagePath="C:\\Users\\saahmed\\workspace\\MFM_Lite\\ScreenShots\\";
...
//		extent.setSystemInfo("UserName", "Mahesh");
	...
	// make the charts visible on report open
        ...
        htmlReporter.config().setDocumentTitle("UDP");
        htmlReporter.config().setReportName("UDP : SANITY-TESTING");
        return htmlReporter;
	...
	{
		test.pass(Message);
		test.assignCategory("UDP : SANITY TESTING");
		return test;
	}
